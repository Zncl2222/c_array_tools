...
UTEST(test_float, c_array_empty_init) {
    c_array_float arr;
...
UTEST(test_float, c_array_assign) {
    c_array_float arr;
    c_array_init(&arr, 3);
...
UTEST(test_float, c_array_resize) {
    c_array_float arr;
    c_array_init(&arr, 3);
...
UTEST(test_float, c_array_set_size) {
    c_array_float arr;
    c_array_init(&arr, 30);
...
UTEST(test_float, c_array_empty) {
    c_array_float arr;
    c_array_init(&arr, 0);
...
UTEST(test_float, c_array_push_back) {
    c_array_float arr;
    c_array_init(&arr, 0);
...
UTEST (test_float, c_array_print_and_printf) {
    c_array_float arr;
    c_array_init(&arr, 0);
...
UTEST(test_float, c_array_reverse) {
    c_array_float arr;
    c_array_init(&arr, 0);
...
UTEST(test_float, c_array_pop_back) {
    c_array_float arr;
    c_array_init(&arr, 0);
...
UTEST(test_float, c_array_insert) {
    c_array_float arr;
    c_array_init(&arr, 0);
...
UTEST(test_float, c_array_remove) {
    c_array_float arr;
    c_array_init(&arr, 0);
...
UTEST(test_float, c_array_concat) {
    c_array_float arr;
    c_array_float arr2;
...
UTEST(test_float, c_array_qsort) {
    c_array_float arr;
...
UTEST(test_float, c_array_msort) {
    c_array_float arr;
...
UTEST(test_float, c_array_min_max) {
    c_array_float arr;
...
UTEST(test_float, c_array_min_max_2) {
    c_array_float arr;
...
UTEST(test_float, c_array_min_max_process) {
    c_array_float arr;
    c_array_init(&arr, 0);
...
UTEST(test_float, c_array_var_std) {
    c_array_float arr;
...
UTEST(test_float, c_array_search) {
    c_array_float arr;
...
UTEST(test_float, c_matrix_init) {
    c_matrix_float mat;
...
UTEST(test_float, c_matrix_copy) {
    c_matrix_float mat1;
    c_matrix_float mat2;
...
UTEST(test_float, c_array_matrix_form) {
    c_array_float arr;
    c_array_init(&arr, 10);
...
UTEST(test_float, c_matrix_flatten) {
    c_matrix_float mat;
    c_matrix_init(&mat, 10, 6);
    ASSERT_EQ(mat.rows, 10);
    ASSERT_EQ(mat.cols, 6);
...
UTEST(test_float, c_matrix_reshape) {
    c_matrix_float mat;
    c_matrix_init(&mat, 10, 6);
    ASSERT_EQ(mat.rows, 10);
    ASSERT_EQ(mat.cols, 6);
...
UTEST(test_float, c_matrix_mean) {
    c_matrix_float mat;
...
UTEST(test_float, c_matrix_max_min) {
    c_matrix_float mat;
...
UTEST(test_float, c_matrix_var_std) {
    c_matrix_float mat;
...
UTEST (test_float, c_matrix_print_and_printf) {
    c_matrix_float mat;
